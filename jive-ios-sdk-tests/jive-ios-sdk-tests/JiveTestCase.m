...
- (void)unexpectedErrorInWaitForTimeOut:(NSError *)error
                            finishBlock:(JiveTestCaseAsyncFinishBlock)finishBlock
                                   ...
                                   line:(int)line {
    NSString *errorMessage = [NSString stringWithFormat:@"Unexpected error: %@ %@",
                              [error localizedDescription], [error userInfo]];
    
    [self failWithException:[NSException failureInFile:[NSString stringWithUTF8String:file]
                                                 atLine:line
...
- (void)runOperation:(NSOperation *)operation file:(const char *)file line:(int)line {
    ...
    JVAssertTrue([operation isFinished], file, line, @"Asynchronous call never finished.");
}
