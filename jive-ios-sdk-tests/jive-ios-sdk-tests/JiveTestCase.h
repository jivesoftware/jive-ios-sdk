...
- (void)waitForTimeout:(JiveTestCaseAsyncBlock)asynchBlock file:(const char *)file line:(int)line;
- (void)unexpectedErrorInWaitForTimeOut:(NSError *)error
                            finishBlock:(JiveTestCaseAsyncFinishBlock)finishBlock
                                   file:(const char *)file
                                   line:(int)line;
- (void)runOperation:(NSOperation *)operation file:(const char *)file line:(int)line;

@end

#define waitForTimeout(block) [self waitForTimeout:block file:__FILE__ line:__LINE__]
#define runOperation(operation) [self runOperation:operation file:__FILE__ line:__LINE__]
#define unexpectedErrorInWaitForTimeout(error, finishBlock) \
    [self unexpectedErrorInWaitForTimeOut:error finishBlock:finishBlock file:__FILE__ line:__LINE__]
