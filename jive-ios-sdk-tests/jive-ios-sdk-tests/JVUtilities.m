...
+ (id) getAPIJsonResponse: (NSString *) userId pw: (NSString*) password URL:(NSString*)urlStr
{
    ...
    NSString *authHeader = [NSString stringWithFormat:@"Basic %@", [data base64EncodedStringWithOptions:0]];
...
{
    if ([returnedAPIDic isKindOfClass:[NSDictionary class]] && [returnedAPIDic valueForKey:@"jive"] != nil && [[returnedAPIDic objectForKey:@"jive"] valueForKey:@"replyCount"] != nil)
    {
        return [[returnedAPIDic objectForKey:@"jive"] objectForKey:@"replyCount"] ;
    }
    
    return nil;
}
+ (NSNumber*) get_Activity_canComment: (id)returnedAPIDic {
    if ([returnedAPIDic isKindOfClass:[NSDictionary class]] && [returnedAPIDic valueForKey:@"jive"] != nil && [[returnedAPIDic objectForKey:@"jive"] valueForKey:@"canComment"] != nil)
    {
        NSString* temp = [[returnedAPIDic objectForKey:@"jive"] objectForKey:@"canComment"] ;
        BOOL boolVal = [temp boolValue];
       return [NSNumber numberWithBool: boolVal];
    }
...
{
   if ([returnedAPIDic isKindOfClass:[NSDictionary class]] && [returnedAPIDic valueForKey:@"error"] != nil && [[returnedAPIDic objectForKey:@"error"] valueForKey:@"status"] != nil)
    {
        return [[[returnedAPIDic objectForKey:@"error"] objectForKey:@"status"] longValue] ;
    }
    return -1;
}
...
{
    if ([returnedAPIDic isKindOfClass:[NSDictionary class]] && [returnedAPIDic valueForKey:@"error"] != nil && [[returnedAPIDic objectForKey:@"error"] valueForKey:@"code"] != nil)
    {
        return [[returnedAPIDic objectForKey:@"error"] objectForKey:@"code"] ;
    }
    return nil;
}
...
{
    if ([returnedAPIDic isKindOfClass:[NSDictionary class]] && [returnedAPIDic valueForKey:@"error"] != nil && [[returnedAPIDic objectForKey:@"error"] valueForKey:@"message"] != nil)
    {
         return [[returnedAPIDic objectForKey:@"error"] objectForKey:@"message"] ;
    }
    return nil;
}
@end
