...
//! Can sso be used for OAuth authentication
@property (nonatomic, readonly) NSNumber *ssoForOAuthGrantEnabled;
//! Convenience method
...
//! Instance edition values
@property (nonatomic, readonly) JiveInstanceEdition *jiveEdition;
