...
@synthesize status, updated, viewCount, visibleToExternalContributors, iconCss, placeID;
...
- (id)persistentJSON {
    ...
    [dictionary setValue:self.iconCss forKey:JivePlaceAttributes.iconCss];
    [dictionary setValue:self.placeID forKey:JivePlaceAttributes.placeID];
...
- (BOOL)canUpdateFollowingIn {
    return [self resourceHasPostForTag:JivePlaceResourceAttributes.followingIn];
}
...
- (BOOL)canDeleteAvatar {
    return [self resourceHasDeleteForTag:JivePlaceResourceAttributes.avatar];
}
