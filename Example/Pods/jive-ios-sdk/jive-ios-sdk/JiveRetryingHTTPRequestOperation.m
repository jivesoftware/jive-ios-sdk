...
@interface JiveInvalidHTTPRequestOperation : AFHTTPRequestOperation<JiveRetryingOperation>
...
@implementation JiveInvalidHTTPRequestOperation
...
+ (id)createOperationForInvalidRequest:(JiveCompletedBlock)errorReporter {
    JiveInvalidHTTPRequestOperation *operation = [JiveInvalidHTTPRequestOperation new];
