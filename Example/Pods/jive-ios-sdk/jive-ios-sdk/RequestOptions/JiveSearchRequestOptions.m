...
- (NSString *)toQueryString {
    ...
    NSString *origin = _origin;
    
    if (origin) {
        if (!query) {
            query = [NSString stringWithFormat:@"origin=%@", origin];
        } else {
            query = [query stringByAppendingFormat:@"&origin=%@", origin];
        }
    }
    ...
    if (!query) {
        query = [NSString stringWithFormat:@"filter=%@", filter];
    } else {
        query = [query stringByAppendingFormat:@"&filter=%@", filter];
    }
