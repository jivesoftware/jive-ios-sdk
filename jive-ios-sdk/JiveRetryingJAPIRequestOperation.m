...
@interface JiveInvalidJAPIRequestOperation : JAPIRequestOperation<JiveRetryingOperation>
...
@implementation JiveInvalidJAPIRequestOperation
...
+ (id)createOperationForInvalidRequest:(JiveCompletedBlock)errorReporter {
    JiveInvalidJAPIRequestOperation *operation = [JiveInvalidJAPIRequestOperation new];
