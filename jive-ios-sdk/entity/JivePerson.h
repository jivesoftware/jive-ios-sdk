...
extern struct JivePersonAttributes {
    ...
    __unsafe_unretained NSString *thumbnailId;
...
//! \class JivePerson
//! https://docs.developers.jivesoftware.com/api/v3/cloud/rest/PersonEntity.html
...
@property(nonatomic, readonly, strong) NSString *thumbnailId;
