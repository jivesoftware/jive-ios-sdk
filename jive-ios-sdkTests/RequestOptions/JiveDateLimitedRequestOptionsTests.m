...
- (void)testAfter {
    ...
    STAssertNotNil(asString, @"Invalid string returned");
    STAssertEqualObjects(@"after=1970-01-01T00:16:40.123+0000", asString, @"Wrong string contents");
}
...
- (void)testBefore {
    ...
    asString = [self.options toQueryString];
    STAssertNotNil(asString, @"Invalid string returned");
    STAssertEqualObjects(@"before=1970-01-01T00:16:40.123+0000", asString, @"Wrong string contents");
}
